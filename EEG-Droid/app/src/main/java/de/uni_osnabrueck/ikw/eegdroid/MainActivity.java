...
public class MainActivity extends AppCompatActivity
    ...
    private TableRow tableRowExperiment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tableRowExperiment = (TableRow) findViewById(R.id.tableRowExperiment);
        ...
        tableRowExperiment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
